...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'torchserve', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-torchserve',
    version=ABOUT['__version__'],
    description='The TorchServe check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent torchserve check',
    ...
    packages=['datadog_checks.torchserve'],
